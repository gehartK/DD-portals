...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isValidHardcoded = validCredentials.some((cred) => cred.email === email && cred.password === password)
    ...
    if (isValidHardcoded || registeredUser) {
      // Store authentication state in localStorage
      localStorage.setItem("isAuthenticated", "true")

      // Store current user info if it's a registered user
      if (registeredUser) {
